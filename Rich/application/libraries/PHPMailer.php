...
class PHPMailer {
   ...
   * @var string			原本為 'root@localhost'
   */
  public $From              = 'qy@qyoung.com.tw';

  /**
   * Sets the From name of the message.
   * @var string			原本為 'Root User'
   */
  public $FromName          = 'QYoung';
  ...
  public function Base64EncodeWrapMB($str) {
    ...
    $length = 75000 - strlen($start) - strlen($end);
